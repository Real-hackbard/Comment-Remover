...
const PAS_Base      = $F00;
  ...
  procedure PAS_SetProgressionAda(Eventer:TPurifyEvent);
   function PAS_NoCommentsAda(RE:TStrings):real;
...
begin
  ...
  for x:=1 to LenStart do
    begin
      ...
      // Remove the string after the double minus.
  ...
  PAS_NoCommentsAda := Length(RE.Text)/LenStart*100;
end;
