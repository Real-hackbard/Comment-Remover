...
const PAS_Base      = $F00;
  ...
  procedure PAS_SetProgressionGo(Eventer:TPurifyEvent);
   function PAS_NoCommentsGo(RE:TStrings):real;
...
begin
  ...
  PAS_NoCommentsGo := Length(RE.Text)/LenStart*100;
end;
